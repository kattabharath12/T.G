              ...
              <div className="space-y-3">
                ...
                <div className="text-sm space-y-2">
                  ...
                  <div className="flex justify-between font-bold">
                    <span>
                      {comprehensiveTaxResult?.phases.phase11_FinalBalance?.finalStatus === 'refund' ? 'Refund:' : 
                       comprehensiveTaxResult?.phases.phase11_FinalBalance?.finalStatus === 'owed' ? 'Amount Owed:' : 'Balance:'}
                    </span>
                    <span className={
                      comprehensiveTaxResult?.phases.phase11_FinalBalance?.finalStatus === 'refund' ? 'text-green-600' : 
                      comprehensiveTaxResult?.phases.phase11_FinalBalance?.finalStatus === 'owed' ? 'text-red-600' : 'text-gray-600'
                    }>
                      {comprehensiveTaxResult?.phases.phase11_FinalBalance?.finalStatus === 'refund' 
                        ? formatCurrency(comprehensiveTaxResult.phases.phase11_FinalBalance.refundAmount)
                        : comprehensiveTaxResult?.phases.phase11_FinalBalance?.finalStatus === 'owed'
                          ? formatCurrency(comprehensiveTaxResult.phases.phase11_FinalBalance.balanceDue)
                          : formatCurrency(0)}
                    </span>
                  </div>
                </div>
          ...
          <div className="space-y-4">
            ...
            <div className="grid md:grid-cols-3 gap-4 p-4 bg-blue-50 rounded-lg">
              ...
              <div className="text-center">
                ...
                <div className="text-sm text-orange-600">Federal Withholdings</div>
              </div>
              <div className="text-center">
                <div className={`text-lg font-bold ${
                  comprehensiveTaxResult?.phases.phase11_FinalBalance?.finalStatus === 'refund' ? 'text-green-700' : 
                  comprehensiveTaxResult?.phases.phase11_FinalBalance?.finalStatus === 'owed' ? 'text-red-700' : 'text-gray-700'
                }`}>
                  {comprehensiveTaxResult?.phases.phase11_FinalBalance?.finalStatus === 'refund' 
                    ? formatCurrency(comprehensiveTaxResult.phases.phase11_FinalBalance.refundAmount)
                    : comprehensiveTaxResult?.phases.phase11_FinalBalance?.finalStatus === 'owed'
                ...
                <div className={`text-sm ${
                  ...
                  {comprehensiveTaxResult?.phases.phase11_FinalBalance?.finalStatus === 'refund' ? 'Your Refund' :
                   comprehensiveTaxResult?.phases.phase11_FinalBalance?.finalStatus === 'owed' ? 'Amount Owed' : 'Balance'}
                </div>
              </div>
            </div>
