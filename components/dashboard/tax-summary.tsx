...
import { Calculator, DollarSign, TrendingUp, FileText, RefreshCw, AlertCircle } from "lucide-react";
          ...
          <>
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-4 pt-2">
                ...
                <div className="text-center">
                  <p className="text-sm text-muted-foreground mb-1">Marginal Rate</p>
