...
import { FileText, TrendingUp, CheckCircle2, Clock, Calculator } from "lucide-react";
      ...
      <main className="container mx-auto px-4 py-8 max-w-7xl">
        ...
        <div className="grid md:grid-cols-4 gap-6 mb-10">
          {[
            ...
            {
              title: "Tax Owed",
              value: taxCalculation ? `$${Math.round(taxCalculation.estimatedTax)}` : "$0",
